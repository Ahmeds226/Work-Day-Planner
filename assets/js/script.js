...
// If a local hourly tasks exist, import them, otherwise initialise the array.
...
// Remove class and add Animation
...
function updateLocalStorage() {
  ...
  if (plannerTask[btnIndex].value.trim() != "") {
    ...
    setTimeout(function () {
      ...
      $(".alert-success").text(
        `Successfully saved task at ${$(".hour")[btnIndex].textContent.trim()}!`
      );
    }, 100);
  }
}
